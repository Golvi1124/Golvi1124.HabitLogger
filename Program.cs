...
void HabitMenu()
{
    ...
    while (isHabitMenuRunning)
    {
        ...
        {
            case "View Habits":
                var habits = GetHabits(); // Call the updated GetHabits method to get the list of habits
                ViewHabits(habits); // Pass the list of habits to the ViewHabits method
                break;
            case "Add Habit":
                AddHabit();
                break;
...
List<Habit> GetHabits() // Update the GetHabits method to return a List<Habit> instead of void.
{
